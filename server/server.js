...
app.get('/temperature', function (req, res) {
    var tempFunction = 'temp' + (req.query.scale || 'C');
    rest.get('https://api.particle.io/v1/devices/' + particleInfo.deviceID + '/'+ tempFunction  +'?access_token=' + particleInfo.accessToken)
